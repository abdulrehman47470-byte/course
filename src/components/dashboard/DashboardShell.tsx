...
const nav = [
  ...
  { label: "Career eBook", to: "/dashboard/ebook" as const, icon: BookMarked },
  { label: "Job Hunting", to: "/dashboard/job-hunting" as const, icon: Search },
  { label: "Scholarships", to: "/dashboard/scholarships" as const, icon: GraduationCap },
