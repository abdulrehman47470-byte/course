...
const nav = [
  ...
  { label: "Payments", to: "/admin/payments" as const, icon: Receipt },
  { label: "Job Listings", to: "/admin/job-listings" as const, icon: Search },
  { label: "Scholarships", to: "/admin/scholarships" as const, icon: GraduationCap },
